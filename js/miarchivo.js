...
class Player {
    ...
    ID() {
        ...
        pjWelcome.textContent = 'Welcome ' + $('#name').val() + '!';
...
$(document).ready(function () {
    $('#btnContinue').mouseup(function () {
        ...
        if ($('#easyMode').prop('checked')) { //Dificultad facil//
            $('#afterForm').append('<p id="toHideIfOption">Were added two members to your team, Ari(Wizard) and Diego(Barbarian), the HP and MP with which they start was increased</p>');
...
$(document).ready(function () {
    $.get("data/tipos.JSON", (respuesta) => {
        ...
        var datosJSON = respuesta;
        console.log(datosJSON);
        respuesta.forEach(element => console.log(element));
...
let story_telling = {
    ...
    "1_c": {
        ...
        "answers": {
            ...
            "i": "Name the goat Gregorio and become best friends.",
        }
    },
    "2_g": {
